...
const DetailRecipe = ({route, navigation}) => {
  ...
  const getMyLikedRecipes = async () => {
    try {
      const res = await axios.get(
        'https://crowded-goat-trunks.cyclic.app/event/liked',
        {
          headers: {
            token,
          },
      ...
      action: async function () {
        try {
          const res = await axios.delete(
            `https://crowded-goat-trunks.cyclic.app/event/bookmark/${idBookmark[0]}`,
            {
              headers: {
                token,
              },
      ...
      action: async function () {
        try {
          const res = await axios.post(
            'https://crowded-goat-trunks.cyclic.app/event',
            data,
            {
              headers: {
                token,
  ...
  const deleteLiked = () => {
    ...
    AlertConfirmation({
      ...
      action: async function () {
        try {
          const res = await axios.delete(
            `https://crowded-goat-trunks.cyclic.app/event/like/${idLiked[0]}`,
            {
              headers: {
                token,
              },
